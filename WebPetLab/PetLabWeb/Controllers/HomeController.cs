            ...
            try
            {
                ...
                if (value.Token == null)
                {
                    ...
                    if (retorno.StatusCode != HttpStatusCode.OK)
                    {
                        ...
                        SessionExtensionsHelp.SetObject(this.HttpContext.Session, "Mensagem", retorno.Content.ToString());
                ...
                if (value.Token != null)
                {
                    ...
                    {
                        SessionExtensionsHelp.SetObject(this.HttpContext.Session, "Mensagem", "Falhar ao realizar login !");
                ...
                SessionExtensionsHelp.SetObject(this.HttpContext.Session, "Mensagem", "Houve uma Falha, Contate o Administrador.");
                return RedirectToAction("Autenticacao", "Login");
            }
            catch (Exception ex)
            {
